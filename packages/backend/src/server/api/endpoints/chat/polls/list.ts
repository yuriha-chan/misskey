		...
		properties: {
			scheduledPolls: {
				...
				properties: {
					...
					startsAt: { type: 'string', optional: true, nullable: true },
				},
			},
		},
		startedPolls: {
			...
			items: {
				...
				properties: {
					...
					userChoices: { type: 'array', optional: true, nullable: true, items: { type: 'object' } },
					textChoices: { type: 'array', optional: true, nullable: true, items: { type: 'string' } },
					fromUserId: { type: 'string', optional: false, nullable: false },
					roomId: { type: 'string', optional: false, nullable: false },
					createdAt: { type: 'string', optional: false, nullable: false },
					finishesAt: { type: 'string', optional: true, nullable: true },
				},
				},
			},
		},
...
export default class extends Endpoint<typeof meta, typeof paramDef> { // eslint-disable-line import/no-default-export
	constructor(
		...
		super(meta, paramDef, async (ps, me) => {
			...
			return await this.chatService.listPoll(ps.roomId, me);
		});
	}
}
