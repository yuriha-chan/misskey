...
export type ChatSecret = components['schemas']['ChatSecret'];
export type ChatSecretRevealed = components['schemas']['ChatSecretRevealed'];
export type ChatPollScheduled = components['schemas']['ChatPollScheduled'];
export type ChatPollStarted = components['schemas']['ChatPollStarted'];
export type ChatPollFinished = components['schemas']['ChatPollFinished'];
export type ChatCard = components['schemas']['ChatCard'];
export type ChatCardRevealed = components['schemas']['ChatCardRevealed'];
