...
export type ICreateSubAccountRequest = operations['i___create-sub-account']['requestBody']['content']['application/json'];
export type IDeleteAccountRequest = operations['i___delete-account']['requestBody']['content']['application/json'];
export type IDeleteSubAccountRequest = operations['i___delete-sub-account']['requestBody']['content']['application/json'];
