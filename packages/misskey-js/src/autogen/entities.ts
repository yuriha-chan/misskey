...
export type ChatCardsListRequest = operations['chat___cards___list']['requestBody']['content']['application/json'];
export type ChatCardsListResponse = operations['chat___cards___list']['responses']['200']['content']['application/json'];
export type ChatCardsRevealRequest = operations['chat___cards___reveal']['requestBody']['content']['application/json'];
export type ChatCardsRevealResponse = operations['chat___cards___reveal']['responses']['200']['content']['application/json'];
...
export type ChatPollsFinishRequest = operations['chat___polls___finish']['requestBody']['content']['application/json'];
export type ChatPollsFinishResponse = operations['chat___polls___finish']['responses']['200']['content']['application/json'];
export type ChatPollsListRequest = operations['chat___polls___list']['requestBody']['content']['application/json'];
export type ChatPollsListResponse = operations['chat___polls___list']['responses']['200']['content']['application/json'];
export type ChatPollsStartRequest = operations['chat___polls___start']['requestBody']['content']['application/json'];
export type ChatPollsStartResponse = operations['chat___polls___start']['responses']['200']['content']['application/json'];
export type ChatPollsVoteRequest = operations['chat___polls___vote']['requestBody']['content']['application/json'];
export type ChatPollsVoteResponse = operations['chat___polls___vote']['responses']['200']['content']['application/json'];
export type ChatRoomsArchiveRequest = operations['chat___rooms___archive']['requestBody']['content']['application/json'];
export type ChatRoomsArchiveResponse = operations['chat___rooms___archive']['responses']['200']['content']['application/json'];
...
export type ChatRoomsKickResponse = operations['chat___rooms___kick']['responses']['200']['content']['application/json'];
export type ChatRoomsLeaveRequest = operations['chat___rooms___leave']['requestBody']['content']['application/json'];
export type ChatRoomsListPublicRequest = operations['chat___rooms___list-public']['requestBody']['content']['application/json'];
export type ChatRoomsListPublicResponse = operations['chat___rooms___list-public']['responses']['200']['content']['application/json'];
...
export type ChatRoomsUpdateMembershipRequest = operations['chat___rooms___update-membership']['requestBody']['content']['application/json'];
export type ChatRoomsUpdateMembershipResponse = operations['chat___rooms___update-membership']['responses']['200']['content']['application/json'];
export type ChatSecretsListRequest = operations['chat___secrets___list']['requestBody']['content']['application/json'];
export type ChatSecretsListResponse = operations['chat___secrets___list']['responses']['200']['content']['application/json'];
export type ChatSecretsRevealRequest = operations['chat___secrets___reveal']['requestBody']['content']['application/json'];
export type ChatSecretsRevealResponse = operations['chat___secrets___reveal']['responses']['200']['content']['application/json'];
