...
<template>
<div
	v-if="!hardMuted && !hideByPlugin && muted === false && !isR18Hidden"
	ref="rootEl"
	v-hotkey="keymap"
...
>
	...
	<article v-else :class="[$style.article, reduceMargin ? $style.reduceMargin : null]" @contextmenu.stop="onContextmenu">
		...
		<div :class="$style.main">
			...
			<div style="container-type: inline-size;">
				...
				<div v-show="appearNote.cw == null || showContent" :class="[{ [$style.contentCollapsed]: collapsed }]">
					<div :class="[$style.text, prefer.s.largeNoteText ? $style.largeText : null]">
			...
			<footer :class="[$style.footer, reduceMargin ? $style.reduceMargin : null]">
...
<div v-else-if="!hardMuted && !hideByPlugin && !isR18Hidden" :class="$style.muted" @click="muted = false">
...
const isR18Hidden = computed(() => (! $i || prefer.s.hideR18Content) && !!appearNote.isR18);
