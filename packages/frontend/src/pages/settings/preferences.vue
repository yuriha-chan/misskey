			...
			<SearchMarker v-slot="slotProps" :keywords="['accessibility']">
				<MkFolder :defaultOpen="slotProps.isParentOfTarget">
					...
					<div class="_gaps_m">
						...
						<div class="_gaps_s">
							<SearchMarker :keywords="['margin', 'space', 'reduce']">
								<MkPreferenceContainer k="reduceMargin">
									<MkSwitch v-model="reduceMargin">
										<template #label><SearchLabel>{{ i18n.ts.reduceUiMargin }}</SearchLabel></template>
									</MkSwitch>
								</MkPreferenceContainer>
							</SearchMarker>

							<SearchMarker :keywords="['large', 'small', 'text', 'font', 'size', 'zoom']">
								<MkPreferenceContainer k="largeNoteText">
									<MkSwitch v-model="largeNoteText">
										<template #label><SearchLabel>{{ i18n.ts.largeNoteText }}</SearchLabel></template>
									</MkSwitch>
								</MkPreferenceContainer>
							</SearchMarker>

							<SearchMarker :keywords="['hide', 'auto', 'footer', 'navigation', 'menu', 'bottom', 'buttons']">
								<MkPreferenceContainer k="hideNavFooter">
									<MkSwitch v-model="hideNavFooter">
										<template #label><SearchLabel>{{ i18n.ts.hideNavFooter }}</SearchLabel></template>
									</MkSwitch>
								</MkPreferenceContainer>
							</SearchMarker>
...
const reduceMargin = prefer.model('reduceMargin');
const largeNoteText = prefer.model('largeNoteText');
const hideNavFooter = prefer.model('hideNavFooter');
