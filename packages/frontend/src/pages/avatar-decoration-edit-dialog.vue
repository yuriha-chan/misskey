...
const animation = ref<string>(props.avatarDecoration ? props.avatarDecoration.animation : '');
const imgAnimation = ref<string>(props.avatarDecoration ? props.avatarDecoration.imgAnimation : '');
const bgAnimation = ref<string>(props.avatarDecoration ? props.avatarDecoration.bgAnimation : '');
const mixBlendMode = ref<string>(props.avatarDecoration ? props.avatarDecoration.mixBlendMode : '');
const bgMixBlendMode = ref<string>(props.avatarDecoration ? props.avatarDecoration.bgMixBlendMode : '');
